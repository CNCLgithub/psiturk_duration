...
var make_mov = function(movname, is_intro, has_ctr) {
  ...
  var mcl = "movieobj";
  var ctr = "";
  var fmovnm = "static/data/movies_filtered/" + movname;
...
var InstructionRunner = function(condlist) {
  ...
  var instructions = [
    ...
    [
        "Try practice holding down the space bar to indicate the duration of this video just played. <br>",
        "movie", "more_pegs_control_2.mp4", true
    ],

    [
        "Try practice holding down the space bar to indicate the duration of this video just played. <br>",
        "movie", "branching_more_pegs_2.mp4", true
    ],
...
$(window).load(function() {
  function do_load() {
    $.ajax({
      dataType: 'json',
      url: "static/data/condlist_new.json",
      async: false,
